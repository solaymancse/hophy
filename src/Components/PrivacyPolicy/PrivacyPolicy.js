...
import { Wrapper } from './../TermsAndCondition/TermsAndConditionElements';
...
export const PrivacyPolicy = () => {
  return (
    <div>
      <Navbar />
      <Wrapper>
        <h4> Privacy Policy for Hophycare:</h4>
        <p style={{ textAlign: "justify" }}>
          At Hophycare, accessible from www.hophycare.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Hophycare and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in Hophycare. This policy
          is not applicable to any information collected offline or via channels
          other than this website.<p/><br/>
          <h4> Consent</h4> 
         ...
         <h3> How we use
          ...
          including to:</p> 
          <li>Provide, operate, and maintain our website</li> Improve,
          ...
          fraud
          <h3> Log Files </h3>
          <p>Hophycare follows a standard procedure of using log
          ...
          <h3>Advertising Partners Privacy
          Policies</h3> You may consult this list to find the Privacy Policy for each
          of the advertising partners of Hophycare. Third-party ad servers or ad
          ...
          on Hophycare, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that Hophycare has no
          access to or control over these cookies that are used by third-party
          advertisers.
          <h3> Third-Party Privacy Policies</h3> Hophycare's Privacy Policy
          ...
          business has collected about consumers. Request that a business
          deletes any personal data about the consumer that a business has
          ...
          their online activity. Hophycare does not knowingly collect any
