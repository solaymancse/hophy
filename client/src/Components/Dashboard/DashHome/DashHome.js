...
import { Center, Left, Top, Bottom, Right,Feature,Amount,Summary} from "./DashHomeElements";
      ...
      <Center>
        <Left>
          ...
          <Bottom>
            ...
            <Amount>$500</Amount>
            <p>Previous Transactions processing.Last payments may <br/>not be included</p>
          </Bottom>
          <Summary>
            <div>
              <h3>Target</h3>
              <p color="red"><IoMdArrowDropdown/> $239</p>
              
            </div>
            <div>
            <h3>Last Week</h3>
              <p color="green"><IoMdArrowDropdown/> $150</p>
            </div>
            <div>
            <h3>Last Month</h3>
              <p color="green"><IoMdArrowDropup/> $450</p>
            </div>
          </Summary>
        </Left>
        <Right>
